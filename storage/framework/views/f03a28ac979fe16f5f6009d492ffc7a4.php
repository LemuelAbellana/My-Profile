...
<head>
    ...
    <title><?php echo e(config('app.name', 'Living Release Note')); ?></title>
...
[$__name, $__params] = $__split('perspective-toggle');

$key = null;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2666701881-0', null);
...
<?php /**PATH D:\My-Profile\resources\views/components/app-layout.blade.php ENDPATH**/ ?>